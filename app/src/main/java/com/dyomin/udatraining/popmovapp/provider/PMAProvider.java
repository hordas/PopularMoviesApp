...
import com.dyomin.udatraining.popmovapp.provider.base.BaseContentProvider;
...
public class PMAProvider extends BaseContentProvider {
    private static final String TAG = PMAProvider.class.getSimpleName();
    ...
    public static final String AUTHORITY = "com.dyomin.udatraining.popmovapp.provider";
    ...
    protected SQLiteOpenHelper createSqLiteOpenHelper() {
        return PMASQLiteOpenHelper.getInstance(getContext());
    }
